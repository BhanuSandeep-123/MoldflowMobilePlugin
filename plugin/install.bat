...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Copy-Item -Path '%~dp0run_startup.vbs' -Destination 'C:\Program Files\Autodesk\Moldflow Synergy 2027\data\commands\run_startup.vbs' -Force"
echo.
